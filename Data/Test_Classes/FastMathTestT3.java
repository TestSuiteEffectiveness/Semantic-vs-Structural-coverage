...
@BeforeClass
   public static void setUp() {
	...
	try{
		results_writer = new FileWriter("./outputTest/T3.txt");
		} catch (IOException e) {
		}
		test_count=1;
  ...
  //  @Test
   ...
   // @Test
    ...
    Set<Integer> selectedTests = new HashSet<Integer>(Arrays.asList(
        new Integer[] {6,12}   // change numbers as you like
    ));
...
public void test02_TanhAccuracyAA() throws Exception {
    ...
    Set<Integer> selectedTests = new HashSet<Integer>(Arrays.asList(
    new Integer[] {
        6,12,13,14,15,16,18,19,20,21,24,26,28,31,32,33,34,35,36,40,44,47,50,51,53,56,59,60,78,87,89,90,93,99,102,105,112,113,115,116,117,121,123,126,129,130,132
    }
));
