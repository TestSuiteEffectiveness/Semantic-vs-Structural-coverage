...
@BeforeClass
   public static void setUp() {
	...
	try{
		results_writer = new FileWriter("./outputTest/T2.txt");
		} catch (IOException e) {
		}
		test_count=1;
  ...
  //  @Test
   ...
   // @Test
    ...
    Set<Integer> selectedTests = new HashSet<Integer>(Arrays.asList(
        new Integer[] {1, 4,8}   // change numbers as you like
    ));
...
public void test02_TanhAccuracyAA() throws Exception {
    ...
    new Integer[] {
		...
		15,16,19,24,25,26,29,30,32,33,34,38,39,41,44,47,50,54,55,56,64,67,71,73,80,88,92,100,105,110,111,120,121,124,126,127
    }
));
