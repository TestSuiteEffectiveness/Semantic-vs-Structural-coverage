...
@BeforeClass
   public static void setUp() {
	...
	try{
		results_writer = new FileWriter("./outputTest/T9.txt");
		} catch (IOException e) {
		}
		test_count=1;
	...
	public  void setUpWriter(){
		try {
		results_writer = new FileWriter("./test_results/T7.txt");
		} catch (IOException e) {
		}
		test_count=1;
	}
  ...
  //  @Test
   ...
   // @Test
    ...
    Set<Integer> selectedTests = new HashSet<Integer>(Arrays.asList(
        new Integer[] {3,8,9}   // change numbers as you like
    ));
...
public void test02_TanhAccuracyAA() throws Exception {
    ...
    Set<Integer> selectedTests = new HashSet<Integer>(Arrays.asList(
    new Integer[] {
13,15,23,25,26,30,31,32,33,34,36,39,40,41,42,43,44,45,47,49,50,51,52,56,58,61,64,67,68,70,71,73,74,75,77,79,80,81,84,86,88,89,90,92,94,95,96,98,101,102,106,107,108,110,118,119,121,123,124,125,128,129,132
    }
));
