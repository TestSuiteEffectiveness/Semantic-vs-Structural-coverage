...
@BeforeClass
   public static void setUp() {
	...
	try{
		results_writer = new FileWriter("./outputTest/T1.txt");
		} catch (IOException e) {
		}
		test_count=1;
  ...
  //  @Test
   ...
   // @Test
    ...
    Set<Integer> selectedTests = new HashSet<Integer>(Arrays.asList(
        new Integer[] {2, 4, 6,8}   // change numbers as you like
    ));
...
public void test02_TanhAccuracyAA() throws Exception {
    ...
    Set<Integer> selectedTests = new HashSet<Integer>(Arrays.asList(
    new Integer[] {
        2,4,6,8,13,18,22,25,26,28,32,37,40,43,46,48,53,58,59,60,
        61,62,66,72,76,80,86,95,96,98,100,103,105,107,112,114,116,
        117,119,121,125,126,129,131
    }
));
